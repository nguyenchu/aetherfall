...
const game = new Phaser.Game({
  ...
  scene: [BootScene, IntroScene, TitleScene, SanctuaryScene, DescentScene, DescentHudScene, BattleScene, BoonScene, DialogueScene, GameMenuScene, RunSummaryScene, ChapterClearScene],
});
